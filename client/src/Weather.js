  ...
  <svg
    ...
    >
      <image
        ...
        x="0"
        y="0"
        href={weatherData.icon}
      ></image>
    </svg>
    <div className="main">{weatherData.temperature}°C</div>
    <div className="mainsub">{weatherData.name}, {weatherData.region}</div>
  ...
  <div className="card2">
    <div className="upper">
      <div className="humidity">
        <div className="humiditytext">Humidity<br/>{weatherData.humidity}%</div>
        <svg
      xmlns="http://www.w3.org/2000/svg"
      width="30"
      height="30"
    ...
    >
      ...
      <div className="air">
        <div className="airtext">Wind<br/>{weatherData.windSpeed} Km/h</div>
        <svg
      xmlns="http://www.w3.org/2000/svg"
      width="30"
      height="30"
    ...
    >
      ...
      ></image>
        ...
        <div className="aqitext">Wind dir<br/>{weatherData.direction}</div>
      </div>
    ...
    >
      ...
      ></image>
        ...
        <div className="realfeeltext">Real Feel<br/>{weatherData.feelLike} °C</div>
      </div>
    ...
    >
      ...
      ></image>
        ...
        <div className="pressuretext">Pressure<br/>{weatherData.pressure} mbar</div>
      </div>
      <div className="card3">
      {weatherData.weather}
      </div>
